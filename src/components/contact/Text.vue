<template>
    <div class="flex gap-x-60 ">
        ...
        <div class="text-left">
            ...
            <p class=" text-1xl lg:text-2xl font-semibold text-[#848484] dark:text-[#848484] sm:text-balance tracking-normal">ООО «AVE MARIA» <br/> MVP 2512355780  <br/>Путевая улица, 12, этаж 5, офис 508 <br/>Центральный внутригородской округ, Краснодар   </p>
