<template>
    ...
    <div class="text-left block lg:hidden">
            ...
            <a href="/licenzia.pdf" download="licenzia" type="button" class="mt-5 text-white bg-[#4286F7] hover:bg-[#4286F7]/80 focus:ring-4 focus:outline-none focus:ring-[#4286F7]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-[#4286F7] dark:hover:text-[#4286F7] dark:hover:bg-white dark:focus:ring-white me-2 mb-2">
                <svg class="w-6 h-6 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 15v2a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3v-2m-8 1V4m0 12-4-4m4 4 4-4"/>
                </svg>
            <p class="text-base">Лицензия</p>
